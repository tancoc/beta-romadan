			...
			<form onSubmit={handleSubmit(onSubmit)}>
				<Flex direction="column" gap={6}>
					...
					<FormControl isInvalid={errors.role}>
						...
						<Select defaultValue={user.role} size="lg" {...register('role', { required: true })}>
					...
					<Table
						...
						td={(user) => (
							<Tr key={user._id}>
								...
								<Td>
									<Badge variant="tinted" colorScheme={user.role === 'Admin' ? 'yellow' : user.role === 'Customer' ? 'blue' : user.role === 'User' && 'red'}>
										{user.role}
									</Badge>
								</Td>
								...
								<Td>
									<Flex justify="end" align="center" gap={3}>
										{user.email !== 'romadandevelopers@gmail.com' && (
											<>
