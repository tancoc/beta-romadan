...
import { Button, Container, Flex, FormControl, FormErrorMessage, FormLabel, Grid, GridItem, Input, Select, Spinner, Text, useToast } from '@chakra-ui/react'
							...
							<Flex direction="column" gap={6}>
								<Flex align="start" direction={{ base: 'column', lg: 'row' }} gap={6}>
									<FormControl isInvalid={errors.region}>
										...
										<Select placeholder="⠀" size="lg" {...register('region', { required: true })}>
									...
									<FormControl isInvalid={errors.barangay}>
										...
										<Select placeholder="⠀" size="lg" {...register('barangay', { required: true })}>
								...
								<FormControl isInvalid={errors.address}>
									...
									<Input size="lg" {...register('address', { required: true })} />
									<FormErrorMessage>This field is required.</FormErrorMessage>
								</FormControl>

								<FormControl isInvalid={errors.postal}>
									<FormLabel>Postal Code</FormLabel>
									<Input type="number" size="lg" {...register('postal', { required: true })} />
									<FormErrorMessage>This field is required.</FormErrorMessage>
								</FormControl>
							</Flex>
						</Card>
